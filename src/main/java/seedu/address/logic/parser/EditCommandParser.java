...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(args, PREFIX_UID, PREFIX_CATEGORY, PREFIX_NAME,
                PREFIX_GENDER, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_DATE_AND_TIME, PREFIX_TAG,
        ...
        editPersonDescriptor.setCategory(ParserUtil.parseCategory(argMultimap.getValue(PREFIX_CATEGORY)));
    ...
    /**
     * Parses {@code Collection<String> datesTimes} into a {@code List<DateTime>} if
     * {@code dateTimes} is non-empty.
     * If {@code datesTimes} contain only one element which is an empty string, it
    ...
    /**
     * Parses {@code Collection<String> dateTimeIndexes} into a
     * {@code List<Integer>}
